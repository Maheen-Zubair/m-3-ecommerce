...
const logo = [
  { id: 1, image: "/free-delivery 1.png" },
  { id: 2, image: "/cashback 1.png" },
  { id: 3, image: "/premium-quality 1.png" },
  { id: 4, image: "/24-hours-support 1.png" },
];
      ...
      <div className="flex-col justify-center items-center gap-2 md:gap-5 flex">
        ...
        <div className="subContainer grid grid-cols-1 sm:grid-cols-2  clg:grid-cols-3 gap-5 ">
          {data.map((blog, index) => (
            <div
              key={index}
              className=" blog w-[280px] sm:w-[300px] llm:w-[365px] group  h-[306px] shadow-md hover:shadow-xl transition-shadow duration-300"
            >
              <div className="h-[87%] flex relative justify-center items-center  hover:bg-white bg-[#F7F7F7]">
                <Image src={blog.image} alt="image" height={200} width={200} />
                <Image
                  src={sale}
                  alt="sale"
                  className="absolute hidden group-hover:flex left-3 top-3"
                />
                <div className=" hidden group-hover:flex w-[30px] h-[30px] absolute top-[126px] left-[15px] rounded-full justify-center items-center bg-[#EEEFFB]">
                  <svg
                    width="15"
                    height="15"
                    viewBox="0 0 15 15"
                ...
                <svg
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  className="top-[170px] left-[23px] absolute hidden group-hover:flex"
                >
                  <path
                ...
                <svg
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  className="top-[200px] left-[24px] absolute hidden group-hover:flex"
                >
                  <path
        ...
        <div className=" flex justify-center flex-col mt-10  items-center gap-2 sm:gap-5 md:gap-10">
          ...
          <div className=" grid  grid-cols-1 sm:grid-cols-2 clg:grid-cols-4 gap-5  transition-shadow duration-300">
            {logo.map((logo, index) => (
              <div
                key={index}
                className="blog w-[270px] h-[320px] mb-8  flex justify-center items-center gap-5 flex-col shadow-lg  hover:shadow-xl transition-shadow duration-300"
              >
                <Image src={logo.image} alt="logo1" height={70} width={70} />
