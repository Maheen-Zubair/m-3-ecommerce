...
export default function Header() {
  ...
  return (
    <div>
      {/* -----------Header 1------------ */}
      <div className=" fixed z-30 top-0 mainContainer h-[35px] xmd:h-[44px] w-screen bg-[#7E33E0] text-white flex justify-center items-center">
          ...
          <div className="part2 flex gap-1  s:gap-3">
            ...
            <div className="wishlistIcon flex justify-center items-center s:gap-1">
              ...
              <Link href={"/shoppingCart"}>
                ...
                <div className=" top-2 right-[228px]  absolute  text-[#0D0E43] text-center font-bold w-3 h-3 rounded-full  bg-white flex justify-center items-center "> <div>0</div></div>
              </Link>
            </div>
          </div>
        </div>
      ...
      <div className="mainContainer  fixed top-[30px] w-full z-20 overflow-y-hidden h-[38px] flex items-center justify-center bg-white pb-[10px] pt-[35px] md:pb-[20px] md:pt-[50px]">
